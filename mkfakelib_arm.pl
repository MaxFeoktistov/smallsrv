...
#
 ...
 $cflag=0;
 $cmd = 'Command line:
 mkfakelib_arm.pl  libxx.so  [TARGET_DIR] [-c] 
 ';
...
#   
  ...
  $cmd = ($cflag)?
     "arm-linux-gnueabi-gcc -pipe -o $pref$bname.so -fno-builtin -fPIC -nostartfiles -nodefaultlibs -shared -O2 $tsrcname -Wl,-soname=$soname"
   : "arm-linux-gnueabi-gcc -pipe -o $pref$bname.so -fno-builtin -fPIC -nostartfiles -nodefaultlibs -shared -O2 $tsrcname -Wl,-soname=$soname" ;
