...
//gcc -s -pipe -m32 -Os md5.c -o md5 -DTEST
//gcc -s -pipe -m64 -Os md5.cpp -o o64/md5.cpp -DTEST
...
#warning " __BYTE_ORDER__  !=  __ORDER_LITTLE_ENDIAN__"
...
void CvtHex(unsigned int  *cd, char * Hex    )
{
...
unsigned char *digest)
{
  ...
  CvtHex((unsigned int  *)digest, bfr    );
   for (i = 0; i < 16; i++)
    printf ("%02x", digest[i]);
//  printf ("\n%s", bfr);
