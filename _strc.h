...
#define sROOT_DIR_ "Root dir=%s def=%s "
...
#define sDON_T_SHO "Do not show directory listing (avilable in registered"\
" version only)"
...
#define sBAD_CODE "Bad code"
#define sTHANK_YOU "Thank you for your support!\r\n%s\r\n"
#define sTHANK_YOU0 "Thank you for your support!"
#define sFREE_TRIA "Free trial finished. Do you want to register?"
#define sFREE_TRIA0 "Free trial finished"
...
#ifndef RUS
#define sNOW_THE_PROGRAM  "Now the program working in evalution mode.\n"\
"In this mode only 3 users will be alowed, other will be ignored.\n"\
"Please register, to shut off this limitation.\n"

#else
#define sNOW_THE_PROGRAM "Программа  работает в ознакомитнльном режиме.\n"\
