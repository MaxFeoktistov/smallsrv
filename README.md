...
#  Small HTTP server  
  ...
  It is not only a web server, it is also Mail servers, DNS, FTP, TFTP, Proxy, DHCP, VPN ... All in one!  
...
##  Build Linux version:  
  ...
  For OpenSSL required openssl-1.1.1-dev or openssl-3.x.x-dev  
...
make o/libsecgnutls.so  
  ```  
  Result will be o/httpd.exe o/libsec111.so o/libsecgnutls.so o/sndmsg  o/shs_vpnclient  o/shs_ctl  
...
make o64/libsecgnutls.so  
  ```  
 Result will be o64/httpd.exe o64/libsec111.so o64/libsecgnutls.so o64/sndmsg o64/shs_vpnclient o64/shs_ctl  
