...
//  GENERATED FILE, DON'T  EDIT THIS!  !!!  Edit t2icfghtm.cpp instead...
...
#define  HTML_TOP1  t2T_622312


#define  HTML_TOP2  t2T_622313
...
// struct sockaddr_in sa;
 ...
 if(KeepAliveList)
 {
   ...
   for(int i=0; i<KeepAliveCount; i++)
   {
     ...
     if(oline.OutConnLine( KeepAliveList[i],   t2T_4129147  )<0)
     {
